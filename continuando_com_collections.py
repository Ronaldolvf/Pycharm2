...
# print(assistiram)
#
# set (assistiram)    # Retira os númeoros repetidos
# print(set(assistiram))
#
#
# usuarios = {1,5,76,34,52,13,17}
#
# usuarios.add(765)   # Adiciona um númeor no conjunto.
# print (len(usuarios))
# print(usuarios)
...
# print(set(meu_texto.split()))   # Quebra o texto em palavras.
#
# aparicoes = {
#   "Guilherme" : 1,
#   "cachorro" : 2,
...
# print (type(aparicoes))         # Aparições é um dicionário.
# print (aparicoes["nome"])       # Procurando o valor dentro do dicionário.
# del aparicoes["vindo"]       # Retira o nome "cachorro" do dicionário.
#
#
# print(aparicoes)
#
#
# for elemento in aparicoes.keys():   # Para busca apenas as chaves.
#     print(elemento)
#
# for elemento in aparicoes.values(): # Para busca apaenas os values.
#     print(elemento)
#
# for elemento in aparicoes.items():  # Imprime uma tupla
#     print(elemento)
...
# meu_texto = "Bem vindo meu nome é Guilherme eu gosto muito de nomes e tenho o meu cachorro e gosto muito de cachorro"
# meu_texto = meu_texto.lower()       # Deixar todo o texto minusculo.
# print(meu_texto)
#
#
# from collections import defaultdict     # Importando o dicionário
#
# aparicoes = defaultdict(int)    # int é uma função que se não recebe nada, devolve zero.
# print(len(meu_texto))
#
...
#
# dicionario = defaultdict(int)   # Se não tiver nunhum número informado, a função irar retorna zero.
# dicionario["gosto"]
# print(dicionario)
#
...
# meu_texto = "Bem vindo meu nome é Guilherme eu gosto muito de nomes e tenho o meu cachorro e gosto muito de cachorro"
#
# from collections import Counter   #   O counter já engloba o zero.
# aparicoes = Counter()
#
# for palavra in meu_texto.split():
#   aparicoes[palavra] += 1
...
def analisa_frequencia_de_letras(texto):
  ...
  aparicoes = Counter (texto.lower())    # O Counter conta qauntas vezes a letra apareceu.
  #print(aparicoes)
  total_de_caracteres = sum (aparicoes.values())    # Somando o total de parições.
  #print(total_de_caracteres)

  proporcoes = [(letra, frequencia / total_de_caracteres) for letra, frequencia in aparicoes.items()]   # Está dando a porcetagem de cada letra.
  #print(proporcoes)


  proporcoes = Counter(dict(proporcoes))    # Criando um dicionário
  mais_comuns = proporcoes.most_common(10)  # Buscando os 10 mais comuns.
  #print(mais_comuns)
  for caractere, proporcao in mais_comuns:
     print("{} => {:.2f}%".format(caractere, proporcao * 100))    # {:.2f} deixa apenas com dois dígitos decimais.


analisa_frequencia_de_letras(texto1)    # Chama a função e o texto que deseja analisar.
